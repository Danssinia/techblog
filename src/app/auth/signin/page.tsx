...
const LoginPage: React.FC<LoginPageProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`text-black min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4 ${className}`}>
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to your TechBlog account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="cursor-pointer w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Sign In
            </button>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/auth/signup"><button className="cursor-pointer text-blue-600 hover:text-blue-500 font-medium transition-colors">
                Sign up here
              </button>
              </Link>
            </p>
